...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _openSearch({String initialQuery = ''}) {
    showModalBottomSheet<void>(
      ...
      builder: (_) {
        return _SearchSheet(initialQuery: initialQuery);
      },
    );
  }
                ...
                slivers: [
                  ...
                  if (controller.errorMessage != null &&
                    ...
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 12.h, 22.w, 0),
                      sliver: SliverToBoxAdapter(
                        child: _ErrorPill(message: controller.errorMessage!),
                      ),
                    ),
                  if (controller.recentlyPlayed.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 22.h, 0, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(
                  ...
                  if (controller.trendingSongs.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 28.h, 0, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(
                          title: 'Trending now',
                          subtitle: 'Fresh from YouTube',
                        ),
                      ),
                    ),
                  ...
                  if (controller.trendingSongs.isNotEmpty)
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: _TrendingList(songs: controller.trendingSongs),
                      ),
                    ),
                  if (controller.trendingArtists.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 24.h, 0, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(
                          title: 'Trending ',
                          subtitle: 'From your current feed',
                        ),
                      ),
                    ),
                  ...
                  if (controller.trendingArtists.isNotEmpty)
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: _ArtistList(
                          artists: controller.trendingArtists,
                          onArtistTap: (artist) {
                            _openSearch(initialQuery: artist);
                          },
                        ),
                      ),
                    ),
                  if (_suggestedSongs.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 26.h, 22.w, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(
                          title: 'Suggested for you',
                          subtitle: 'More music to explore',
                        ),
                      ),
                    ),
                  ...
                  if (controller.playlists.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 26.h, 0, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(title: 'Your playlists'),
                      ),
                    ),
                  ...
                  if (controller.playlists.isNotEmpty)
                    SliverToBoxAdapter(
                      child: Padding(
                        padding: EdgeInsets.only(top: 10.h),
                        child: _PlaylistList(playlists: controller.playlists),
                      ),
                    ),
                  if (controller.favorites.isNotEmpty)
                    SliverPadding(
                      padding: EdgeInsets.fromLTRB(22.w, 26.h, 22.w, 0),
                      sliver: const SliverToBoxAdapter(
                        child: _SectionTitle(title: 'Your favorites'),
                      ),
                    ),
                      ...
                      sliver: SliverList.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            padding: EdgeInsets.only(bottom: 7.h),
                            child: _SongTile(
                              song: controller.favorites[index],
                              index: index,
                              favorite: true,
                            ),
                          );
...
Future<void> _playAndOpenNowPlaying(
  ...
  await controller.playSong(song, sourceQueue: sourceQueue);
...
Future<void> _showHomePlaylistPicker(BuildContext context, Song song) async {
  final controller = MusicControllerProvider.instance;
...
class _RecentlyPlayedList extends StatelessWidget {
  ...
  const _RecentlyPlayedList({required this.songs});
...
class _RecentlyPlayedCard extends StatelessWidget {
  ...
  Future<void> _play(BuildContext context) async {
    await _playAndOpenNowPlaying(context, song: song, sourceQueue: songs);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
          behavior: HitTestBehavior.opaque,
          onTap: () => _play(context),
          onLongPress: () => _showSongOptions(context, song, queue: songs),
          child: SizedBox(
            width: 236.w,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      fit: StackFit.expand,
                      children: [
                        _Artwork(url: song.thumbnailUrl, cropBlackBars: true),
                        Positioned.fill(
                          child: DecoratedBox(
                            decoration: BoxDecoration(
        ...
        .animate()
        .fadeIn(delay: (45 * index).ms, duration: 450.ms)
        .slideX(
          begin: 0.07,
          end: 0,
          delay: (45 * index).ms,
...
class _TrendingList extends StatelessWidget {
  ...
  const _TrendingList({required this.songs});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return _TrendingCard(song: songs[index], index: index);
        },
      ),
    );
  }
...
class _TrendingCard extends StatelessWidget {
  ...
  const _TrendingCard({required this.song, required this.index});

  Future<void> _play(BuildContext context) async {
    await _playAndOpenNowPlaying(
      context,
      song: song,
      sourceQueue: MusicControllerProvider.instance.trendingSongs,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        .animate()
        .fadeIn(delay: (35 * index).ms, duration: 400.ms)
        .slideX(
          begin: 0.05,
          end: 0,
          delay: (35 * index).ms,
...
class _ArtistList extends StatelessWidget {
  ...
  const _ArtistList({required this.artists, required this.onArtistTap});
...
class _ArtistChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        .animate()
        .fadeIn(delay: (25 * index).ms, duration: 320.ms)
        .slideX(begin: 0.04, end: 0, delay: (25 * index).ms, duration: 320.ms);
  }
}
...
class _SongTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
          ...
          onLongPress: () => _showSongOptions(context, song, queue: queue),
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Material(
                  ...
                  child: InkWell(
                    borderRadius: BorderRadius.circular(18.r),
                    onTap: () => _showSongOptions(context, song, queue: queue),
                    child: SizedBox(
                      width: 44.w,
                      height: 44.w,
                      child: Center(
        ...
        .animate()
        .fadeIn(delay: (20 * index).ms, duration: 330.ms)
        .slideY(
          begin: 0.025,
          end: 0,
          delay: (20 * index).ms,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (context, index) => SizedBox(width: 11.w),
        itemBuilder: (context, index) {
          return _PlaylistCard(playlist: playlists[index], index: index);
        },
      ),
    );
  }
...
class _PlaylistCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        .animate()
        .fadeIn(delay: (30 * index).ms, duration: 350.ms)
        .slideX(begin: 0.04, end: 0, delay: (30 * index).ms, duration: 350.ms);
  }
}
...
class _PlaylistArtwork extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (songs.length == 1) {
      return _Artwork(url: songs.first.thumbnailUrl, cropBlackBars: true);
    }

    return Stack(
      fit: StackFit.expand,
      children: [
        _Artwork(url: songs.first.thumbnailUrl, cropBlackBars: true),
        Positioned(
          right: -16.w,
          bottom: -16.w,
          child: ClipRRect(
            ...
            child: SizedBox(
              width: 105.w,
              height: 105.w,
              child: _Artwork(url: songs[1].thumbnailUrl, cropBlackBars: true),
            ),
          ),
        ),
      ],
...
class _Artwork extends StatelessWidget {
  ...
  const _Artwork({required this.url, this.cropBlackBars = false});
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRect(child: cropBlackBars ? image(scale: 1.42) : image());
  }
}
...
class _ErrorPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Hicons.informationCircleBold, size: 17.sp),
          SizedBox(width: 8.w),
          Expanded(
            child: Text(
              message,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Hicons.musicnoteLightOutline, size: 30.sp),
            ),
...
class _SearchSheet extends StatefulWidget {
  ...
  const _SearchSheet({this.initialQuery = ''});
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (widget.initialQuery.trim().isNotEmpty) {
        controller.search(widget.initialQuery);
      }
    });
  }
            ...
            return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.fromLTRB(18.w, 7.h, 18.w, 10.h),
                        child: Container(
                          height: 56.h,
                          decoration: BoxDecoration(
                            color: theme.colorScheme.surface,
...
class _SearchResults extends StatelessWidget {
  ...
  String _durationText(Song song) {
    final duration = song.duration;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      controller: scrollController,
      padding: EdgeInsets.fromLTRB(18.w, 4.h, 18.w, 35.h),
      physics: const BouncingScrollPhysics(),
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: _SearchResultTile(
            song: song,
            index: index,
            durationText: _durationText(song),
          ),
        );
      },
    );
